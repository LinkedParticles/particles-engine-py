...
when a triple's subject is not one of the subjects the particle is about. That
is the cheapest signal that the structurizer picked the wrong entity. The fix is
always to regenerate the annotation; the claim needs no change:
